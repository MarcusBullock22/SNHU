...
{
    // initialize housekeeping variables private
private:
	Node* root;
	...
	// initialize housekeeping variables public
public:
	BinarySearchTree();
	virtual ~BinarySearchTree();
	void inOrder();
...
void BinarySearchTree::addNode(Node* node, Bid bid) 
{
	...
	int myKey = atoi(node->bid.bidId.c_str());
	int key = atoi(bid.bidId.c_str());

	cout << "Current key is: " << myKey << endl;
